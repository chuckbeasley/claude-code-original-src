...
# const voiceCommand = feature('VOICE\_MODE')
...
# Notable flags: `PROACTIVE`, `KAIROS`, `BRIDGE\_MODE`, `DAEMON`, `VOICE\_MODE`, `AGENT\_TRIGGERS`, `MONITOR\_TOOL`
